...
__decorate([
    ...
    (0, class_validator_1.Length)(5, 150, { message: 'Email must be between 5 and 150 characters' }),
    __metadata("design:type", String)
], CreateClienteDto.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Client phone', required: false, example: '11999999999' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)({ message: 'Phone must be a string' }),
    (0, class_validator_1.Length)(10, 20, { message: 'Phone must be between 10 and 20 characters' }),
    __metadata("design:type", String)
], CreateClienteDto.prototype, "telefone", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Client CPF', required: false, example: '12345678901' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)({ message: 'CPF must be a string' }),
    (0, class_validator_1.Length)(11, 14, { message: 'CPF must be between 11 and 14 characters' }),
    __metadata("design:type", String)
