...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Product name', example: 'Laptop Dell' }),
    (0, class_validator_1.IsString)({ message: 'Name must be a string' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'Name is required' }),
    __metadata("design:type", String)
], CreateProdutoDto.prototype, "nome", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Product description', required: false, example: 'High performance laptop' }),
    (0, class_validator_1.IsString)({ message: 'Description must be a string' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateProdutoDto.prototype, "descricao", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Product price', example: 2500.99 }),
...
__decorate([
    ...
    (0, class_validator_1.IsInt)({ message: 'Client ID must be an integer' }),
    (0, class_validator_1.IsPositive)({ message: 'Client ID must be positive' }),
    __metadata("design:type", Number)
], CreateProdutoDto.prototype, "clienteId", void 0);
